...
const Contact = () => {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    try {
      ...
      fetch(`
          ${API}email/send?name=${email.name}&phone=${email.phone}&messageText=${email.messageText}`,{
            method: 'GET',
      }).then(response => {
          if (response.ok) {
      ...
      <div className={darkTheme ? "form-wrapper dark-theme" : 'form-wrapper'} id="form-wrapper">
        ...
        <div className="form-container">
          <div className="form-info-container">
            ...
            <a href="mailto:wifvpersonal@gmail.com" className="info-block">
              ...
              <h5>Email</h5>
              <div className="color-2">wifvpersonal@gmail.com</div>
            </a>
            <a href="https://t.me/Nizomiddinusta" className="info-block">
              <svg fill="#000000" width="800px" height="800px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className="svg">
                <path d="M29.919 6.163l-4.225 19.925c-0.319 1.406-1.15 1.756-2.331 1.094l-6.438-4.744-3.106 2.988c-0.344 0.344-0.631 0.631-1.294 0.631l0.463-6.556 11.931-10.781c0.519-0.462-0.113-0.719-0.806-0.256l-14.75 9.288-6.35-1.988c-1.381-0.431-1.406-1.381 0.288-2.044l24.837-9.569c1.15-0.431 2.156 0.256 1.781 2.013z" strokeWidth={2}/>
              </svg>
              <h5>Telegram</h5>
              <div className="color-2">+9983057664</div>
            </a>
            <a href="https://www.instagram.com/wifv_personal" className="info-block">
              <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="svg">
              ...
              <h5>Instagram</h5>
              <div className="color-2">@wifv_personal</div>
            </a>
          </div>
